...
lib/
  ...
  features/
    ...
    logging/             # food search, log, barcode, templates, today's entries
...
### Drift (database)
- 7 tables (schema v2): `foods`, `food_entries`, `bodyweight_entries`, `user_goals`, `meal_templates`, `recipes`, `recipe_ingredients`
